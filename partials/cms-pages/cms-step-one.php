  ...
  <div class="stepContainer">
    ...
    <div class="step1">
      ...
      <div class="step1__basicInfoForm">
        ...
        <div class="stepBtns">
          <a href="" class="back">
            <svg id="arrowBackRed" class="goTo_back"viewBox="0 0 55 41" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <div class="step2">
      <h3>Step 2 of 4</h3>
      <div class="step2__line"></div>
      <div class="step2__basicInfo">
        <h4>Basic Info</h4>
        <p>Do you have a grerat photo for the event? No worries if you don’t, you can skip it but remeber a picture says more than a thousand words.</p>
      </div>
      <div class="step2__imgDropBox">
        <p>Drag image here or <span>click to upload</span></p>
      </div>
      <div class="stepBtns">
        <a id="fromTwotoOne" class="back">
          <svg id="arrowBackRed" class="goTo_back"viewBox="0 0 55 41" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <polygon id="Fill-47" fill="#FF6565" points="23.7075205 0.727521992 5.02448493 19.3900503 23.7075205 38.0518097" class="arrowBackRed_back"></polygon>
            <path d="M52.7709271,19.3897427 L0.588842192,19.3897427" id="Stroke-48" stroke="#3E3E3E" stroke-width="3"></path>
            <polyline id="Stroke-49" stroke="#3E3E3E" stroke-width="3" points="19.0837233 0.727521992 0.400687671 19.3900503 19.0837233 38.0518097"></polyline>
        ...
        <a id="fromTwotoThree" class="next"><span>Next</span>
          <svg id="arrowForwRed" class="goTo_next" viewBox="0 0 55 41" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" >
            <polygon id="Fill-41" fill="#FF6565" points="29.3808877 0.727521992 48.0639233 19.3900503 29.3808877 38.0518097" class="arrowForwRed_next"></polygon>
            <path d="M0.31740411,19.3897427 L52.499489,19.3897427" id="Stroke-42" stroke="#3E3E3E" stroke-width="3"></path>
            <polyline id="Stroke-43" stroke="#3E3E3E" stroke-width="3" points="34.0046079 0.727521992 52.6876436 19.3900503 34.0046079 38.0518097"></polyline>
    ...
    <div class="step3">
      <h3>Step 3 of 4</h3>
      <div class="step3__line"></div>
      <div class="step3__basicInfo">
        <h4>Basic Info</h4>
      ...
      <div class="step3__checkboxContainer">
        <div class="step3__checkboxContainer__checkboxSteps checkboxContainer">
          <input type="checkbox" id="checkbox-8">
          <label for="checkbox-8"><span class="checkbox">Frontend</span></label>
        </div>
        <div class="step3__checkboxContainer__checkboxSteps">
          <input type="checkbox" id="checkbox-9">
          <label for="checkbox-9"><span class="checkbox">Backend</span></label>
        </div>
        <div class="step3__checkboxContainer__checkboxSteps">
          <input type="checkbox" id="checkbox-10">
          <label for="checkbox-10"><span class="checkbox">UI Design</span></label>
        </div>
        <div class="step3__checkboxContainer__checkboxSteps">
          <input type="checkbox" id="checkbox-11">
          <label for="checkbox-11"><span class="checkbox">UX Design</span></label>
        </div>
      </div>
      <div class="step3__basicInfo">
        <p>Do you have some keywords that might help with the search</p>
      </div>
      <div class="step3__keywordContainer">
        <div class="keyword">
          Javascript
        </div>
        <div class="keyword">
          ...
          <p><span>more tags...</span></p>
      </div>
      <div class="stepBtns">
        <a id="fromThreetoTwo" class="back">
          <svg id="arrowBackRed" class="goTo_back"viewBox="0 0 55 41" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <polygon id="Fill-47" fill="#FF6565" points="23.7075205 0.727521992 5.02448493 19.3900503 23.7075205 38.0518097" class="arrowBackRed_back"></polygon>
            <path d="M52.7709271,19.3897427 L0.588842192,19.3897427" id="Stroke-48" stroke="#3E3E3E" stroke-width="3"></path>
            <polyline id="Stroke-49" stroke="#3E3E3E" stroke-width="3" points="19.0837233 0.727521992 0.400687671 19.3900503 19.0837233 38.0518097"></polyline>
        ...
        <a id="fromThreetoFour" class="next"><span>Next</span>
          <svg id="arrowForwRed" class="goTo_next" viewBox="0 0 55 41" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" >
            <polygon id="Fill-41" fill="#FF6565" points="29.3808877 0.727521992 48.0639233 19.3900503 29.3808877 38.0518097" class="arrowForwRed_next"></polygon>
            <path d="M0.31740411,19.3897427 L52.499489,19.3897427" id="Stroke-42" stroke="#3E3E3E" stroke-width="3"></path>
            <polyline id="Stroke-43" stroke="#3E3E3E" stroke-width="3" points="34.0046079 0.727521992 52.6876436 19.3900503 34.0046079 38.0518097"></polyline>
    ...
    <div class="step4">
      <h3>Step 4 of 4</h3>
      <div class="step4__line"></div>
      <div class="step4__basicInfo">
        <h4>Basic Info</h4>
        <p>But I can’t give you this case, it don’t belong to me. Besides, I’ve already been through too much shit this morning over this case to hand it over to your dumb ass.</p>
      </div>
      <div class="step4__checkboxContainer">
        <div class="step4__checkboxContainer__checkboxSteps checkboxContainer">
          <input type="checkbox" id="checkbox-12">
          <label for="checkbox-12"><span class="checkbox">Drinks <strong>(alcoholic)</strong></span></label>
        </div>
        <div class="step4__checkboxContainer__checkboxSteps">
          <input type="checkbox" id="checkbox-13">
          <label for="checkbox-13"><span class="checkbox">Drinks <strong>(non-alcoholic)</strong></span></label>
        </div>
        <div class="step4__checkboxContainer__checkboxSteps">
          <input type="checkbox" id="checkbox-14">
          <label for="checkbox-14"><span class="checkbox">Food/snacks</span></label>
        </div>
      </div>
      ...
      <div class="stepBtns">
        <a id="fromFourtoThree" class="back">
          <svg id="arrowBackRed" class="goTo_back"viewBox="0 0 55 41" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <polygon id="Fill-47" fill="#FF6565" points="23.7075205 0.727521992 5.02448493 19.3900503 23.7075205 38.0518097" class="arrowBackRed_back"></polygon>
            <path d="M52.7709271,19.3897427 L0.588842192,19.3897427" id="Stroke-48" stroke="#3E3E3E" stroke-width="3"></path>
            <polyline id="Stroke-49" stroke="#3E3E3E" stroke-width="3" points="19.0837233 0.727521992 0.400687671 19.3900503 19.0837233 38.0518097"></polyline>
        ...
        <a id="fromFourtoDone" class="next"><span>Next</span>
          <svg id="arrowForwRed" class="goTo_next" viewBox="0 0 55 41" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" >
            <polygon id="Fill-41" fill="#FF6565" points="29.3808877 0.727521992 48.0639233 19.3900503 29.3808877 38.0518097" class="arrowForwRed_next"></polygon>
            <path d="M0.31740411,19.3897427 L52.499489,19.3897427" id="Stroke-42" stroke="#3E3E3E" stroke-width="3"></path>
            <polyline id="Stroke-43" stroke="#3E3E3E" stroke-width="3" points="34.0046079 0.727521992 52.6876436 19.3900503 34.0046079 38.0518097"></polyline>
